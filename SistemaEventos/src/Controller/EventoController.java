...
public class EventoController {
    ...
    public boolean insert(EventoModel evento){
        ...
        Conexao conexao = new Conexao();
        conexao.conectar();
        String sql = "insert into evento (nome, descricao, data_inicio, data_fim, id_local) values (?,?,?,?,?)";
        try {
            PreparedStatement sentenca = conexao.conector.prepareStatement(sql);
            ...
            sentenca.setInt(5, evento.getIdLocal());
    ...
    public boolean update(EventoModel evento){
        ...
        Conexao conexao = new Conexao();
        conexao.conectar();
        String sql = "update evento set nome = ?, descricao = ?, data_inicio = ?, data_fim = ?, id_local = ? where id = ?";
        ...
        try {
            ...
            sentenca.setObject(4, evento.getDataFim());
            sentenca.setInt(5, evento.getIdLocal());
            sentenca.setInt(6, evento.getIdEvento());
